...
// #define QUICK_HOME             //---> To be checked for homing style   // If G28 contains XY do a diagonal move first
// #define HOME_Y_BEFORE_X        //---> To be checked for homing style   // If G28 contains XY home Y before X
// #define HOME_Z_FIRST           //---> To be checked for homing style   // Home Z first. Requires a real endstop (not a probe).
// #define CODEPENDENT_XY_HOMING  //---> To be checked for homing style   // If X/Y can't home without homing Y/X first
