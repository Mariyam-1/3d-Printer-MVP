 ...
 */
#define THERMOCOUPLE_MAX_ERRORS 15 //---> done
 ...
 */
// #define HEPHESTOS2_HEATED_BED_KIT //---> done
...
// #define CHAMBER_CHECK_INTERVAL 5000 //---> done // (ms) Interval between checks in bang-bang control
...
#define THERMAL_PROTECTION_PERIOD 40    //---> To be calibrated// (seconds)
#define THERMAL_PROTECTION_HYSTERESIS 4 //---> To be calibrated// (°C)

// #define ADAPTIVE_FAN_SLOWING   //---> To be calibirated if problem found in the hotEnd temprature        // Slow part cooling fan if temperature drops
 ...
 * below 2.
 */
#define WATCH_TEMP_PERIOD 40  //---> To be calibrated and if problem found we will modify the time // (seconds)
#define WATCH_TEMP_INCREASE 2 //---> done //(°C)
#endif

/**
 * Thermal Protection parameters for the bed are just as above for hotends.//---> to be modified if problem is found in bed temp
 */
 ...
 */
// #define THERMAL_PROTECTION_VARIANCE_MONITOR   //---> done // Detect a sensor malfunction preventing temperature updates
#endif

#if ENABLED(PIDTEMP)
// Add an additional term to the heater power, proportional to the extrusion speed.
// A well-chosen Kc value should add just enough power to melt the increased material volume.
// #define PID_EXTRUSION_SCALING //---> To be modified if we have a problem with the extrusion speed.
 ...
 */
// #define PID_FAN_SCALING //--> done, disabled for now if problem with hot end temp found uncomment this first "ADAPTIVE_FAN_SLOWING" if still prob found enable this
 ...
 */
#define AUTOTEMP //--->done
#if ENABLED(AUTOTEMP)
#define AUTOTEMP_OLDWEIGHT 0.98 // Factor used to weight previous readings (0.0 < value < 1.0)
// Turn on AUTOTEMP on M104/M109 by default using proportions set here
#define AUTOTEMP_PROPORTIONAL //---> done
...
// #define SHOW_TEMP_ADC_VALUES //---> done
...
// #define MAX_CONSECUTIVE_LOW_TEMPERATURE_ERROR_ALLOWED 0 //--->  done , modified if thermistor starting temp issue occured
 ...
 */
// #define MILLISECONDS_PREHEAT_TIME 0 //--->  done , modified if thermistor starting temp issue occured
 ...
 */
#define EXTRUDER_RUNOUT_PREVENT //---> done
 ...
 */
#define HOTEND_IDLE_TIMEOUT //---> done
 ...
 */
// #define USE_CONTROLLER_FAN //---> done, not used
 ...
 */
#define FAN_KICKSTART_TIME 100  // (ms)   //---> done
#define FAN_KICKSTART_POWER 180 // 64-255 //---> done

// Some coolers may require a non-zero "off" state.
#define FAN_OFF_PWM 1 //---> done
 ...
 */
// #define FAN_MIN_PWM 50 //---> done, commented cause we have nore than material with different fan speeds
// #define FAN_MAX_PWM 128//---> done, commented cause we have nore than material with different fan speeds
 ...
 */
#define FAST_PWM_FAN //---> done   // Increase the fan PWM frequency. Removes the PWM noise but increases heating in the FET/Arduino
#if ENABLED(FAST_PWM_FAN)
#define FAST_PWM_FAN_FREQUENCY 31400 //---> done  // Define here to override the defaults below
 ...
 */
// #define REDUNDANT_PART_COOLING_FAN 1  //---> done // Index of the fan to sync with FAN 0.
...
// #define ENDSTOPS_ALWAYS_ON_DEFAULT //---> To be modified during calibration if problem found during longtime prints

// @section extras

#define Z_LATE_ENABLE //---> done // Enable Z the last moment. Needed if your Z driver overheats.

// Employ an external closed loop controller. Override pins here if needed.
// #define EXTERNAL_CLOSED_LOOP_CONTROLLER //---> done
...
// #define EXT_SOLENOID //---> done it doesnot exists in hardware.
...
// #define HOMING_BACKOFF_POST_MM { 2, 2, 2 }  //---> done // (linear=mm, rotational=°) Backoff from endstops after homing
// #define XY_COUNTERPART_BACKOFF_MM 0         // (mm) Backoff X after homing Y, and vice-versa

// #define QUICK_HOME             //---> done  // If G28 contains XY do a diagonal move first
// #define HOME_Y_BEFORE_X        //---> done  // If G28 contains XY home Y before X
// #define HOME_Z_FIRST           //---> done  // Home Z first. Requires a real endstop (not a probe).
// #define CODEPENDENT_XY_HOMING  //---> done  // If X/Y can't home without homing Y/X first

// @section bltouch //---> done to be modified if problrms found during calibration.
 ...
 */
// #define Z_STEPPER_AUTO_ALIGN //---> done
...
// #define REPORT_TRAMMING_MM       //---> done, to be uncommented if we want to display it on the lcd  // Report Z deviation (mm) for each point relative to the first

// #define ASSISTED_TRAMMING_WIZARD //---> done, to be uncommented if we want to display it on the lcd  // Add a Tramming Wizard to the LCD menu
...
#define AXIS_RELATIVE_MODES {false, false, false, false} //---> done, absolute mode is used

// Add a Duplicate option for well-separated conjoined nozzles
// #define MULTI_NOZZLE_DUPLICATION

// By default pololu step drivers require an active high signal. However, some high power drivers require an active low signal as step.
#define INVERT_X_STEP_PIN true //---> active
#define INVERT_Y_STEP_PIN true //---> active
#define INVERT_Z_STEP_PIN true //---> active
...
#define INVERT_E_STEP_PIN true //---> active
...
// #define DISABLE_IDLE_Z //---> done // Disable if the nozzle could fall onto your printed part!
 ...
 */
#define XY_FREQUENCY_LIMIT 10 //---> done // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
 ...
 */
#define ADAPTIVE_STEP_SMOOTHING //---> done
...
/**
 *  @section  stepper motor current //--->done, different type of motors
 *
